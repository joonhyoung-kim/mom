        ...
        for (var loop = 0; loop < that.processTran[index].length; loop++) {
            ...
            if (that.processTran[index][i]['dataField'] == 'INIT') {
                ...
                if (that.processTran[index][i]['headerText'] == 'SEARCH') {
                    ...
                    var message = that.procCallInit(index, 'R', {
                        param: undefined,
                        callBackParam: undefined
                    }, indexInfoList[i], your);
                    if (message != 'SUCCESS') {
                        that.messageBox({type: 'warning', width: '400', height: '145', html: message});
                        return;
                    }
                    ...
                    mom_ajax('R', that.processTran[index][i]['dropDown'], {}, function (result, data) {
                        ...
                        for (var j = 0; j < data.length; j++) {
                            ...
                            AUIGrid.addColumn(that.grid[index], {
                                dataField: colId,
                                headerText: colName/*
																										 * ,
																										 * dataType:
                        ...
                        your.grid2CallInit(function (initParam) {
                            ...
                            mom_ajax('R',
                                ...
                                function (result, data) {
                                    var columnLayout =
                                        AUIGrid.getColumnLayout(that.grid[index]);
                                    var column =
                                            ...
                                            if (columnLayout[i].dataField.indexOf('Qty') > -1) {
                                                if (data[0][columnLayout[i].dataField] != undefined) {
                                                    ...
                                                    if (columnLayout[i].dataField.indexOf('m') > -1) {
                                                        ...
                                                        columnLayout[i].headerText =
                                                            data[0][columnLayout[i].dataField];
                                                    }
                                                } else {
                        ...
                        if (actionToken == 'form') {
                                ...
                                setTimeout(function () {
                                    ...
                                    if (that.searchFilter[index][param * -1]['sortIndex'] == undefined || that.searchFilter[index][param * -1]['sortIndex'] == '') {
                                        that.messageBox({
                                            ...
                                            width: '400',
                                            height: '145',
                                            html: that.searchFilter[index][param * -1]['headerText'] + ' ' + multiLang.transText('MESSAGE', 'MSG00043')
                                        });
                                        return;
                                    }
                            ...
                            if (checkedItems.length < 1) {
                                ...
                                that.messageBox({
                                    ...
                                    width: '400',
                                    height: '145',
                                    html: Language.lang['MESSAGES11605']
                                });
                                return;
                            }
                    ...
                    if (that.processTran[index][i]['filter']) {
                        ...
                        if (your != undefined && your.groupDelMsg != undefined) {
                            that.messageBox({
                                ...
                                width: '400',
                                height: '145',
                                html: your.groupDelMsg + that.processTran[index][i]['headerText'] + ' 하시겠습니까?',
                            ...
                            that.messageBox({
                                ...
                                width: '400',
                                height: '145',
                                html: ioMonth + that.processTran[index][i]['headerText'] + ' 하시겠습니까?',
                                closeButton: {text: 'Close'},
                                okButton: {
                                    text: 'OK', after: function () {
                        ...
                        if (actionFirstToken[2] == 'form') {
                            ...
                            if (checkedItems == undefined || checkedItems.length < 1) {
                                that.messageBox({
                                    ...
                                    width: '400',
                                    height: '145',
                                    html: Language.lang['MESSAGES11335']
                                });
                                return;
                            }
                            param = AUIGrid.getCheckedRowItems(that.grid[index], true)[0]['item'];
...
//					 }
    ...
    setBtnEvent: function (index, your) {
        ...
        $(document).on('click', '.bntpopclose, ' + '#' + cancelBtnId, function () {
            //$('#defaultPop' + (index + 1)).modal("hide");
            $('#defaultPop' + (index + 1)).css('display', 'none');
            that.maskHide('1');
