...
var VIEW= {
    ...
    searchCallInit: function(index,your,action,btnId,param,result,event) { //조회액션 실행 전에 호출되는 함수   
        ...
        if(index==1){				
		    result.param = {receiveNo:checkItem[0].receiveNo,inoutType:'RO',vendorCd:checkItem[0]['vendorCd'],departureLocationCd:checkItem[0]['departureLocationCd'],iqcFlag:checkItem[0]['iqcFlag'],currencyCd:checkItem[0]['currencyCd']};	
		} 
	    else if(index==20){		
		    result.param = {receiveNo:checkItem[0].receiveNo,inoutType:'RO',vendorCd:checkItem[0]['vendorCd'],departureLocationCd:checkItem[0]['departureLocationCd'],iqcFlag:checkItem[0]['iqcFlag'],currencyCd:checkItem[0]['currencyCd']};	
		}
