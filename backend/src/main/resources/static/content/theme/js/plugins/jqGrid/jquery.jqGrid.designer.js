	...
	groupingRender : function (grdata, colspans, page, rn ) {
		return this.each(function(){
			...
			$.each(grp.groups,function(i,n){
				...
				hid = clid+"_"+i;
				icon = "<span style='cursor:pointer;margin-right:8px;margin-left:5px;' class='" + common.icon_base +" "+pmrtl+"' onclick=\"jQueryTmp('#"+$.jgrid.jqID($t.p.id)+"').jqGrid('groupingToggle','"+hid+"');return false;\"></span>";
				try {
...
//module begin
	...
	$.fn.fmatter.actions = function(cellval,opts) {
		...
		var hover = "onmouseover=jQueryTmp(this).addClass('" + common.hover +"'); onmouseout=jQueryTmp(this).removeClass('" + common.hover +"');  ";
