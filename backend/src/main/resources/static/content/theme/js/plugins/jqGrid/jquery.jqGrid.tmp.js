		...
		this._compareValues=function(func,f,v,how,t){
			...
			switch(swst) {
				...
				case 'datetime':
					...
					fld = 'jQuery.jgrid.parseDate.call(jQueryTmp("#'+$.jgrid.jqID($t.p.id)+'")[0],"'+t.srcfmt+'",'+fld+').getTime()';
					break;
				default :
...
//	khp4.22		pgid = ts.p.pager ? $.jgrid.jqID(ts.p.pager.substr(1)) : "",
			pgid = ts.p.pager ? $(ts.p.pager).attr('id') : "",
			tspg = pgid ? "_" + pgid : "",
			...
			pgboxes = $(ts).parentsUntil(".ui-jqgridui-jqgrid.ui-widget").find('.m-pager');
			if(pgboxes) {
...
//khp 4.22				    $("#input" + tspg).html($.jgrid.template($.jgrid.getRegional(ts, "defaults.pgtext", ts.p.pgtext) || "", "<input class='ui-pg-input ui-corner-all' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(pgid) + "'></span>"));
				    $("#input" + tspg).html($.jgrid.template($.jgrid.getRegional(ts, "defaults.pgtext", ts.p.pgtext) || "", "<input class='ui-pg-input ui-corner-all' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + pgid + "'></span>"));
				    if (ts.p.toppager) {
//khp 4.22				        $("#input_t" + tspg_t).html($.jgrid.template($.jgrid.getRegional(ts, "defaults.pgtext", ts.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(pgid) + "_toppager'></span>"));
				        $("#input_t" + tspg_t).html($.jgrid.template($.jgrid.getRegional(ts, "defaults.pgtext", ts.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + pgid + "_toppager'></span>"));
                    }
...
*/
		...
		setPager = function (pgDom, tp){
			...
			var pgid = pgDom.attr('id');
//khp			pgid = pgid.substr(1);
			tp += "_" + pgid;
			pgcnt = "pg_"+pgid;
...
//khp 4.22			    $("td#" + pgid + "_" + ts.p.recordpos, "#" + pgcnt).append("<div dir='" + dir + "' style='text-align:" + ts.p.recordpos + "' class='ui-paging-info'></div>");
			    $("td#" + pgid + "_" + ts.p.recordpos, $(pgDom)).append("<div dir='" + dir + "' style='text-align:" + ts.p.recordpos + "' class='ui-paging-info'></div>");
			    
			}
			$("td#"+pgid+"_"+ts.p.pagerpos,$(pgDom)).append(pgl);
			...
			if(twd > 0) {
				...
				$("td#" + pgid + "_" + ts.p.pagerpos, $(pgDom)).width(twd);
			}
			ts.p._nvtd = [];
			ts.p._nvtd[0] = twd ? Math.floor((ts.p.width - twd)/2) : Math.floor(ts.p.width/3);
			ts.p._nvtd[1] = 0;
			pgl=null;
			$('.ui-pg-selbox', $(pgDom)).bind('change', function () {
			...
			if(ts.p.pgbuttons===true) {
			    $(".ui-pg-button", $(pgDom)).hover(function () {
		...
		if(ts.p.pager){
		    ...
		    if (typeof ts.p.pager === "string") {
		        if (ts.p.pager.substr(0, 1) !== "#") {
		            ts.p.pager =  $(ts).parentsUntil(".ui-jqgridui-jqgrid.ui-widget").find('.m-pager');
		        }
		        ts.p.pager = $(ts).parentsUntil(".ui-jqgridui-jqgrid.ui-widget").find('.m-pager');
            }
		    else {
		    ...
		    //khp 04.22        else { ts.p.pager = "#" + $(ts.p.pager).attr("id"); }
...
//khp 04.20				bt = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + fid + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:" + align + "'>" + bC + tmpl + "</td><td class='EditButton' " + butleft + ">" + bQ + bS + "</td></tr></tbody></table>";
				bt = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + fid + "_2'><tbody><tr></tr><tr><td class='EditButton' style='text-align:" + align + "'>" + bC + tmpl + "</td><td class='EditButton' " + butleft + ">" + bQ + bS + "</td></tr></tbody></table>";
				fid = $.jgrid.jqID(fid);
				$("#"+fid).jqFilter({
					columns: columns,
...
$.jgrid.extend({
	editGridRow : function(rowid, p){
		...
		return this.each(function(){
			...
			bp = rtlb ? "nData" : "pData",
			bn = rtlb ? "pData" : "nData";
		    var bP = "<a id='" + bp + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon fa fa-angle-left'></span></a>",
			bN = "<a id='" + bn + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon fa fa-angle-right'></span></a>",
			...
			var bt = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + frmtborg + "_2'><tbody><tr></tr><tr id='Act_Buttons'><td class='navButton'>" + (rtlb ? bN + bP : bP + bN) + "</td><td class='EditButton'>" + bS + bC + "</td></tr>";
			//khp var bt = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + frmtborg + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (rtlb ? bN + bP : bP + bN) + "</td><td class='EditButton'>" + bS + bC + "</td></tr>";
...
//khp				tbl += "<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" + dtbl + "_2'><tbody><tr><td><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + bS + "&#160;" + bC + "</td></tr></tbody></table>";
				tbl += "<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" + dtbl + "_2'><tbody><tr></tr><tr><td class='DelButton EditButton'>" + bS + "&#160;" + bC + "</td></tr></tbody></table>";
				p.gbox = "#gbox_" + $.jgrid.jqID(gID);
				...
				if(p.delicon[0]===true) {
					...
					.append("<span class='fa "+p.delicon[2]+"'></span>");
				}
				if(p.cancelicon[0]===true) {
					$("#eData","#"+dtbl+"_2").addClass(p.cancelicon[1] === "right" ? 'fm-button-icon-right' : 'fm-button-icon-left')
					.append("<span class='fa "+p.cancelicon[2]+"'></span>");
				}
...
//			if(this.p.navGrid) {return;}
			...
			for(i = 0; i<clone; i++) {
				...
				if (o.add) {
					...
					$(tbd).append("<div class='ui-pg-div'><span class='fa "+o.addicon+"'></span>"+o.addtext+"</div>");
				...
				if (o.edit) {
					tbd = $("<td class='ui-pg-button ui-corner-all'></td>");
					$(tbd).append("<div class='ui-pg-div'><span class='fa "+o.editicon+"'></span>"+o.edittext+"</div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
				...
				if (o.view) {
					tbd = $("<td class='ui-pg-button ui-corner-all'></td>");
					$(tbd).append("<div class='ui-pg-div'><span class='fa "+o.viewicon+"'></span>"+o.viewtext+"</div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
				...
				if (o.del) {
					tbd = $("<td class='ui-pg-button ui-corner-all'></td>");
					$(tbd).append("<div class='ui-pg-div'><span class='fa "+o.delicon+"'></span>"+o.deltext+"</div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
				...
				if (o.search) {
					tbd = $("<td class='ui-pg-button ui-corner-all'></td>");
					$(tbd).append("<div class='ui-pg-div'><span class='fa "+o.searchicon+"'></span>"+o.searchtext+"</div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
				...
				if (o.refresh) {
					tbd = $("<td class='ui-pg-button ui-corner-all'></td>");
					$(tbd).append("<div class='ui-pg-div'><span class='fa "+o.refreshicon+"'></span>"+o.refreshtext+"</div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
				...
				$("#testpg2").remove();
				var pageDiv = $($t).parentsUntil(".ui-jqgridui-jqgrid.ui-widget").find('.m-pager');
				$(pgid + "_" + o.position, pageDiv).append(navtbl);
//				$(pgid + "_" + o.position, pgid).append(navtbl);
				if ($t.p._nvtd) {
					if(twd > $t.p._nvtd[0] ) {
					    $(pgid + "_" + o.position, pageDiv).width(twd);
						$t.p._nvtd[0] = twd;
					}
					$t.p._nvtd[1] = twd;
				}
		...
		return this.each(function() {
			...
			if (findnav) {
				...
				if(p.buttonicon.toString().toUpperCase() === "NONE") {
					...
					$(tbd).addClass('ui-pg-button ui-corner-all').append("<div class='ui-pg-div'><span class='fa "+p.buttonicon+"'></span>"+p.caption+"</div>");
				}
	...
	groupingRender : function (grdata, colspans, page, rn ) {
		return this.each(function(){
			...
			$.each(grp.groups,function(i,n){
				...
				hid = clid+"_"+i;
				icon = "<span style='cursor:pointer;' class='ui-icon "+pmrtl+"' onclick=\"jQueryTmp('#"+$.jgrid.jqID($t.p.id)+"').jqGrid('groupingToggle','"+hid+"');return false;\"></span>";
				try {
		    ...
		    // sjjo 수정 iframe에서 호출 안되는 문제 디자이너
			//$("#"+$.jgrid.jqID($t.p.id)+" tbody:first").append(str); 
			var tables = $("#" + $.jgrid.jqID($t.p.id) + " tbody:first");
			if(tables.length < 1){
			    tables = $("iframe").contents().find("body").find("#table_jqgrid");
			}
			    tables.append(str);
			// free up memory
			str = null;
...
$.jgrid.extend({
	...
	jqPivot : function( data, pivotOpt, gridOpt, ajaxOpt) {
		return this.each(function(){
			...
			function pivot( data) {
				var pivotGrid = jQueryTmp($t).jqGrid('pivotSetup',data, pivotOpt),
				...
				jQueryTmp($t).jqGrid($.extend(true, {
				...
				if(gHead.length) {
					for( i = 0;i < gHead.length ; i++) {
						if(gHead[i] && gHead[i].groupHeaders.length) {
							jQueryTmp($t).jqGrid('setGroupHeaders',gHead[i]);
						}
					}
				}
				if(pivotOpt.frozenStaticCols) {
					jQueryTmp($t).jqGrid("setFrozenColumns");
				}
			}
				...
				$(ts.rows[i].cells[pos]).bind('click', function() {
					...
					if($(this).hasClass("sgcollapsed")) {
						...
						if(ts.p.subGridOptions.reloadOnExpand === true || ( ts.p.subGridOptions.reloadOnExpand === false && !$r.hasClass('ui-subgrid') ) ) {
							...
							$(tr).after( "<tr role='row' id='" + pID + "_" + _id + "_expandedContent" + "' class='ui-subgrid ui-sg-expanded'>"+atd+"<td class='ui-widget-content subgrid-cell'><span class='fa "+ts.p.subGridOptions.openicon+"'></span></td><td colspan='"+parseInt(ts.p.colNames.length-1-nhc,10)+"' class='ui-widget-content subgrid-data'><div id="+pID+"_"+_id+" class='tablediv'></div></td></tr>" );
...
//module begin
	...
	$.fn.fmatter.actions = function(cellval,opts) {
		...
		if(op.editformbutton){
			ocl = "id='jEditButton_"+rowid+"' onclick=jQuery.fn.fmatter.rowactions.call(this,'formedit'); onmouseover=jQueryTmp(this).addClass('ui-state-hover'); onmouseout=jQueryTmp(this).removeClass('ui-state-hover'); ";
			...
			ocl = "id='jEditButton_"+rowid+"' onclick=jQuery.fn.fmatter.rowactions.call(this,'edit'); onmouseover=jQueryTmp(this).addClass('ui-state-hover'); onmouseout=jQueryTmp(this).removeClass('ui-state-hover'); ";
			str += "<div title='"+nav.edittitle+"' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' "+ocl+"><span class='ui-icon ui-icon-pencil'></span></div>";
		}
		if(op.delbutton) {
			ocl = "id='jDeleteButton_"+rowid+"' onclick=jQuery.fn.fmatter.rowactions.call(this,'del'); onmouseover=jQueryTmp(this).addClass('ui-state-hover'); onmouseout=jQueryTmp(this).removeClass('ui-state-hover'); ";
		...
		ocl = "id='jSaveButton_"+rowid+"' onclick=jQuery.fn.fmatter.rowactions.call(this,'save'); onmouseover=jQueryTmp(this).addClass('ui-state-hover'); onmouseout=jQueryTmp(this).removeClass('ui-state-hover'); ";
		...
		ocl = "id='jCancelButton_"+rowid+"' onclick=jQuery.fn.fmatter.rowactions.call(this,'cancel'); onmouseover=jQueryTmp(this).addClass('ui-state-hover'); onmouseout=jQueryTmp(this).removeClass('ui-state-hover'); ";
