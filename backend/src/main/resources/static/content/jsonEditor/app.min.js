        ...
        return function(e) {
                ...
                return n.modes = {}, n.prototype._create = function(e, t, i) {
                    ...
                    if (i.isArray(e))
                        ...
                        for (t = 0; t < r.length; t++)
                            if (o = r[t], o in e.mixin) throw new Error('Reserved property "' + o + '" not allowed in mixin');
                        n.modes[s] = e
                    }
            ...
            n = [i(8), i(3)], o = function(e, t) {
                ...
                return i.create = function(i, n) {
                    ...
                    s.className = "format", s.title = "Format JSON data, with proper indentation and line feeds (Ctrl+\\)", this.menu.appendChild(s), s.onclick = function() {
                        try {
                            o.format()
                        } catch (e) {
                            o._onError(e)
                    ...
                    var r = document.createElement("button");
                    if (r.className = "compact", r.title = "Compact JSON data, remove all whitespaces (Ctrl+Shift+\\)", this.menu.appendChild(r), r.onclick = function() {
                            try {
                                o.compact()
                            } catch (e) {
                                o._onError(e)
                    ...
                    if (this.content = document.createElement("div"), this.content.className = "outer", this.frame.appendChild(this.content), this.container.appendChild(this.frame), "code" == this.mode) {
                        ...
                        l.setTheme("ace/theme/jsoneditor"), l.setShowPrintMargin(!1), l.setFontSize(13), l.getSession().setMode("ace/mode/json"), l.getSession().setTabSize(this.indentation), l.getSession().setUseSoftTabs(!0), l.getSession().setUseWrapMode(!0), this.editor = l;
            ...
            n = [i(9), i(10), i(3)], o = function(e, t, i) {
                ...
                n.prototype._updateEditability = function() {
                    ...
                    if (s)
                        for (; s.length;) this.removeChild(s[0]);
                    ...
                    if (13 == l) {
                        ...
                        if (u && !d) s = this._nextNode(), s && s.focus(n.focusElement || this._getElementName(c)), g = !0;
                        else if (u && d && f) {
    ...
    function() {
        ...
        (function() {
            this.addRules = function(e, t) {
                ...
                if (this.addRules(r, t), n)
                    for (var c = Array.prototype[s ? "push" : "unshift"], a = 0; a < o.length; a++) c.apply(this.$rules[o[a]], i.deepCopy(n));
                ...
                function i(s) {
                    ...
                    for (var a = 0; a < r.length; a++) {
                        ...
                        if (l.push && (l.nextState = l.next || l.push, l.next = e, delete l.push), l.rules)
                            for (var d in l.rules) o[d] ? o[d].push && o[d].push.apply(o[d], l.rules[d]) : o[d] = l.rules[d];
        ...
        (function() {
            this.MAX_RANGES = 500, this.setRegexp = function(e) {
                ...
                if (this.regExp)
                    for (var r = s.firstRow, a = s.lastRow, l = r; a >= l; l++) {
                        var c = this.cache[l];
        ...
        function i() {
            this.getFoldAt = function(e, t, i) {
                ...
                if (null == e ? (i = new n(0, 0, this.getLength(), 0), t = !0) : i = "number" == typeof e ? new n(e, 0, e, this.getLine(e).length) : "row" in e ? n.fromPoints(e, e) : e, o = this.getFoldsInRangeList(i), t) this.removeFolds(o);
                    ...
                    for (var s = o; s.length;) this.expandFolds(s), s = this.getFoldsInRangeList(i);
        ...
        (function() {
            this.$setMaxTokenCount = function(e) {
                ...
                for (var l, c = [], h = 0, d = {
                    ...
                    if (f)
                        if ("string" == typeof u) g && g.merge === !1 || d.type !== u ? (d.type && c.push(d), d = {
                            type: u,
                            value: f
                        }) : d.value += f;
                        else if (u) {
            ...
            this.tokenRe = new RegExp("^[" + s.packages.L + s.packages.Mn + s.packages.Mc + s.packages.Nd + s.packages.Pc + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + s.packages.L + s.packages.Mn + s.packages.Mc + s.packages.Nd + s.packages.Pc + "\\$_]|\\s])+", "g"), this.getTokenizer = function() {
                ...
                if (!this.completionKeywords) {
                    var t = this.$tokenizer.rules,
                        i = [];
                    for (var n in t)
                        for (var o = t[n], s = 0, r = o.length; r > s; s++)
                            if ("string" == typeof o[s].token) / keyword | support | storage / .test(o[s].token) && i.push(o[s].regex);
                            else if ("object" == typeof o[s].token)
                        for (var a = 0, l = o[s].token.length; l > a; a++)
                            if (/keyword|support|storage/.test(o[s].token[a])) {
            ...
            this.set = function(e) {
                ...
                if (t.$isMultiLine) {
                    ...
                    e: for (var d = a.offset || 0; h >= d; d++) {
                        for (var u = 0; c > u; u++)
                            if (-1 == s[d + u].search(a[u])) continue e;
                        var g = s[d],
                            f = s[d + c - 1],
                    ...
                    for (var v = 0; v < s.length; v++)
                        for (var A = i.getMatchOffsets(s[v], a), u = 0; u < A.length; u++) {
                            var C = A[u];
        ...
        (function() {
            ...
            i.implement(this, s), this.setDocument = function(e) {
                ...
                if (null == t) s = n.length - 1, o = this.getLine(e).length;
                    ...
                    for (var s = 0; s < n.length && (o += n[s].value.length, !(o >= t)); s++);
                ...
                var t, i = this.$useWrapMode,
                    ...
                    a = e.data.range.end,
                    l = null;
                if (-1 != n.indexOf("Lines") ? (s = "insertLines" == n ? o + e.data.lines.length : o, t = e.data.lines ? e.data.lines.length : s - o) : t = s - o, this.$updating = !0, 0 != t)
            ...
            this.$computeWrapSplits = function(e, t) {
                ...
                var e = 0,
                    t = null;
                if (this.$useWrapMode)
                    for (var i = this.$wrapData.length, n = 0, o = 0, t = this.$foldData[o++], s = t ? t.start.row : 1 / 0; i > n;) {
        ...
        (function() {
            this.addCommand = function(e) {
                ...
                for (var n in i)
                    for (var o in i[n]) i[n][o] == e && delete i[n][o]
            ...
            n.implement(this, s), this.setSession = function(e) {
                ...
                if (this.$annotations.length) {
                    var t = e.data,
                        ...
                        o = i.end.row - n;
                    if (0 !== o)
                        if ("removeText" == t.action || "removeLines" == t.action) this.$annotations.splice(n, o + 1, null);
                        else {
                            var s = new Array(o + 1);
                ...
                if (e) {
                    ...
                    for (var i in this.markers) {
                        ...
                        if (o.range) {
                            ...
                            if (!s.isEmpty())
                                if (s = s.toScreenRange(this.session), o.renderer) {
        ...
        (function() {
            i.implement(this, s), this.EOF_CHAR = "쨋", this.EOL_CHAR_LF = "짭", this.EOL_CHAR_CRLF = "짚", this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = "&nbsp;", this.SPACE_CHAR = "쨌", this.$padding = 0, this.$updateEolChar = function() {
                ...
                function i(e, t, i) {
                    for (var n = 0, s = 0; s + e[n].value.length < t;)
                        if (s += e[n].value.length, n++, n == e.length) return;
                    if (s != t) {
        ...
        function i(e) {
            function t() {
                ...
                if (u != n)
                    if (u = n.text.join("<br/>"), c.setHtml(u), c.show(), a.on("mousewheel", i), e.$tooltipFollowsMouse) s(d);
                    else {
        ...
        if ((a = g(h, "__defineGetter__")) && (n = l.bind(h.__defineGetter__), o = l.bind(h.__defineSetter__), s = l.bind(h.__lookupGetter__), r = l.bind(h.__lookupSetter__)), 2 != [1, 2].splice(0).length)
            if (function() {
                    function e(e) {
                        var t = new Array(e + 2);
                        return t[0] = t[1] = 0, t
                ...
                if (e === i) s && this.push.apply(this, o);
                    ...
                    if (s && e === h) this.length = h, this.push.apply(this, o);
                        ...
                        for (this.length = h + s, u = 0; s > u; ++u) this[e + u] = o[u]
                }
                return n
            };
        ...
        if (Array.prototype.forEach || (Array.prototype.forEach = function(e) {
                ...
                if ("[object Function]" != u(e)) throw new TypeError(e + " is not a function");
                for (var s = 0; n > s; s++)
                    if (s in i && !e.call(o, i[s], s, t)) return !1;
                return !0
                ...
                if ("[object Function]" != u(e)) throw new TypeError(e + " is not a function");
                for (var s = 0; n > s; s++)
                    if (s in i && e.call(o, i[s], s, t)) return !0;
                return !1
        ...
        var $ = "	\n\f\r 혻��롡�곣귘꺿꾟끸녳뉍댿됤듼�걼�\u2028\u2029癤�";
        ...
        o && n || (RegExp.prototype.exec = function(s) {
            ...
            if ("string" == typeof s && l) {
                if (!n && l.length > 1 && t(l, "") > -1 && (a = RegExp(this.source, i.replace.call(e(this), "g", "")), i.replace.call(s.slice(l.index), a, function() {
                    ...
                    for (var c = 1; c < l.length; c++) r = this._xregexp.captureNames[c - 1], r && (l[r] = l[c]);
            ...
            this.getRowLength = function(e) {
                ...
                if (t) {
                    var i = e.data,
                        ...
                        s = n.end.row - o;
                    if (0 !== s)
                        if ("removeText" == i.action || "removeLines" == i.action) {
        ...
        (function() {
            i.implement(this, n), this.setValue = function(e) {
                ...
                for (var i = this.$lines || this.getAllLines(), n = this.getNewLineCharacter().length, o = t || 0, s = i.length; s > o; o++)
    ...
    function e(e, t, i, n, o) {
        try {
            ...
            if (s.onreadystatechange = function() {
                ...
                for (var r in n) n.hasOwnProperty(r) && s.setRequestHeader(r, n[r]);
            s.send(i)
        } catch (a) {
            o(a, null, 0)
        }
...
app.doc = {
    ...
    try {
        app.notify = new Notify, app.retriever = new FileRetriever({
            // TODO : Script Url 확인 필요
            scriptUrl: "fileretriever.php",
            notify: app.notify
        }), app.store = new OnlineStore({
            url: "http://api.jsoneditoronline.org/v1/docs/",
            notify: app.notify
        });
        ...
        if (location.pathname.toUpperCase().indexOf("REST") < 0) {
            // Custom Button 추가 by.joon
            // 검색 버튼
            var n = document.getElementById("searchBtn");
            if (n != null)
                n.onclick = app.searchData;

            // Import 버튼
            var o = document.getElementById("importBtn");
            if (o != null)
                o.onclick = app.importData;

            // Import OK 버튼
            var importOk = document.getElementById("btnImport");
            if (importOk != null)
                importOk.onclick = app.ImportDataOk;
            ...
            if (saveBtn != null)
                saveBtn.onclick = app.saveShowModal;

            var delBtn = document.getElementById("delBtn");
            if (delBtn != null)
                delBtn.onclick = app.delShodwModal;
        }
...
, app.getCategory = function () {
    var url = "/DataBuilder/GetCategory";
    var param = { type : 'J' };
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.success) {
                var columnInfo = { value: 'Value', text: 'Text' };
                Common.SetSelectBox(data.result, columnInfo, $('#searchCategory'), true);
            }
            else {
...
}, app.getSQLId = function (){

    var strUrl = "/DataBuilder/GetSQLID/";
    prm = {};
    prm.Type = "J";
    prm.GUBUN = "D";
    prm.Category = $('#searchCategory').val();
    $.post(strUrl, prm, function (data) {
        if (!data.success) {
            alert(data.errMsg);
            return;
        }
        ...
        var row = data.result;
        $.each(row, function (i) {
            var optionTemplate = "<option>" + row[i] + "</option>";
            $("#SQLID").append(optionTemplate);
        });
    ...
    var frameH = $(i, parent.document).height();
    i.style.height = $(window).height() - 56 + "px";
    t.style.height = $(window).height() - 56 + "px";
}, app.importData = function () {
    
    // Search Button
    $('#modal-import').modal('show');
    $('.importInfo').removeClass('hidden');
    $('.importTbl').addClass('hidden');
    $('#modal-import #txtUrl').val("");
    $('#saveBtn').removeAttr('disabled');
    $('#delBtn').removeAttr('disabled');
    $('.form-group').show();
}, app.getSQLStatement = function () {
    var strUrl = "/DataBuilder/GetSQLStatement/";
    prm = {};
    prm.Type = "J";
    prm.GUBUN = "D";
    prm.SQLID = $("#SQLID").val();
    ...
    $.post(strUrl, prm, function (data) {
        ...
        $('#selectedGuid').val(data.result.guid);
        $('#selectedGuid').attr('data-category', data.result.category);
        $('#selectedGuid').attr('data-comment', data.result.comment);
        $('#selected_id').html(prm.SQLID);
        
        codeEditor.setText(data.result.json);
        app.CodeToTree();
        app.treeToCode();
        $('#splash').hide();
        $('#modal-search').modal('hide');
...
}, app.getComments = function (actionType) {
    
    var strUrl = "/DataBuilder/GetComment";
    prm = {};
    prm.Type = "J";
    prm.GUBUN = "D";

    // modal 이 save Default 일 경우
    var oSQLID = $('#SQLID');
    var oComment = $("#sqlComment");
    // delete 일 경우
    if (typeof actionType != 'undefined' && actionType == "D") {
        oSQLID = $('#deleteSQLID')
        oComment = $('#deleteComment');
    }
    prm.sqlID = $(oSQLID).val();
    $.post(strUrl, prm, function (data) {
        if (!data.success) {
            alert(data.errMsg);
            return;
        }
        $(oComment).val(data.result);
    }).error(function (request, status, error) {
        alert("code:" + request.status + "\n" + "message:" + request.responseText + "\n" + "error:" + error);
    });
}, app.reset = function () {
    ...
    $("#deleteSQLID").attr('disabled', 'disabled');
    $("#deleteSQLID").val('');
    $("#deleteComment").val('');
    $('#selected_id').html('');
    $('#SAVE_SQLID').val('');
...
}, app.saveShowModal = function () {
    if ($('#remoteID').length > 0 && $('#remoteID').val() == "" || $('#remoteURL').val() == "") {
        //alert('ID나 URL 항목을 없습니다.');
        Common.AlertMessage("Save Json", "ID나 URL 항목이 없습니다.");
        return;
    }

    if ($('#remoteID').length < 1)
    {
        if (codeEditor.getText() == "{}" || codeEditor.getText() == "") {
            alert('Data가 없습니다.');
            return;
        }
    }
    ...
    if ($('#selectedGuid').length > 0 && $('#selectedGuid').val() != "")
    {
        $('#SAVE_SQLID').val($('#selected_id').html());
        $('#saveCategory').val($("#selectedGuid").attr('data-category'));
        $('#saveComment').val($("#selectedGuid").attr('data-comment'));
        app.getComments();
    }

    $('#modal-save').modal('show');
}, app.delShodwModal = function () {
    var selectedSQL = $("#selected_id").html();

    if (typeof selectedSQL == 'undefined' || selectedSQL == "") {
        alert('선택한 SQL이 없습니다.');
        return;
    }
    $('#modal-delete').modal('show');
    $('#delete-OKBtn').next().show();
    $('#deleteInfos').show();
    $('#deleteCompleteMessage').hide();
    $("#deleteSQLID").val(selectedSQL);
    var actionType = "D" // Delete
    app.getComments(actionType);
