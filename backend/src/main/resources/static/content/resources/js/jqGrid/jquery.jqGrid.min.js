...
b(a){var
c,d,f,g,h,i,j=0;if(null!=a.groups){for(d=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase(),d&&t.orBegin(),c=0;c<a.groups.length;c++){j>0&&d&&t.or();try{b(a.groups[c])}catch(a){alert(a)}j++}d&&t.orEnd()}if(null!=a.rules)try{f=a.rules.length&&"OR"===a.groupOp.toString().toUpperCase(),f&&t.orBegin();var
l;for(c=0;c<a.rules.length;c++){if(h=a.rules[c],g=a.groupOp.toString().toUpperCase(),s[h.op]&&h.field){j>0&&g&&"OR"===g&&(t=t.or()),l=h.field,e.p.useNameForSearch&&n.hasOwnProperty(h.field)&&(l=n[h.field]);try{i=k[l],"date"===i.stype&&i.srcfmt&&i.newfmt&&i.srcfmt!==i.newfmt&&(h.data=$.jgrid.parseDate.call(e,i.newfmt,h.data,i.srcfmt)),t=s[h.op](t,g)(h.field,h.data,i)}catch(a){}}j++}f&&t.orEnd()}catch(a){alert(a)}}var
c,d,f,g,h=e.p.multiSort?[]:"",i=[],j=!1,k={},l=[],m=[],n={};if($.isArray(e.p.data)){var
o,p,q,r=!!e.p.grouping&&e.p.groupingView;if($.each(e.p.colModel,function(){if("cb"===this.name||"subgrid"===this.name||"rn"===this.name)return!0;if(d=this.sorttype||"text",q=this.index||this.name,"date"===d||"datetime"===d?(this.formatter&&"string"==typeof
this.formatter&&"date"===this.formatter?(c=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:$.jgrid.getRegional(e,"formatter.date.srcformat"),f=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:$.jgrid.getRegional(e,"formatter.date.newformat")):c=f=this.datefmt||"Y-m-d",k[q]={stype:d,srcfmt:c,newfmt:f,sfunc:this.sortfunc||null}):k[q]={stype:d,srcfmt:"",newfmt:"",sfunc:this.sortfunc||null},e.p.useNameForSearch&&(n[this.name]=q),e.p.grouping)for(p=0,o=r.groupField.length;p<o;p++)this.name===r.groupField[p]&&(l[p]=k[q],m[p]=q);e.p.multiSort||j||q!==e.p.sortname||(h=q,j=!0)}),e.p.multiSort&&(h=u,i=v),e.p.treeGrid&&e.p._sort)return void
$(e).jqGrid("SortTree",h,e.p.sortorder,k[h].stype||"text",k[h].srcfmt||"");var
s={eq:function(a){return a.equals},ne:function(a){return a.notEquals},lt:function(a){return a.less},le:function(a){return a.lessOrEquals},gt:function(a){return a.greater},ge:function(a){return a.greaterOrEquals},cn:function(a){return a.contains},nc:function(a,b){return"OR"===b?a.orNot().contains:a.andNot().contains},bw:function(a){return a.startsWith},bn:function(a,b){return"OR"===b?a.orNot().startsWith:a.andNot().startsWith},en:function(a,b){return"OR"===b?a.orNot().endsWith:a.andNot().endsWith},ew:function(a){return a.endsWith},ni:function(a,b){return"OR"===b?a.orNot().equals:a.andNot().equals},in:function(a){return a.equals},nu:function(a){return a.isNull},nn:function(a,b){return"OR"===b?a.orNot().isNull:a.andNot().isNull}},t=$.jgrid.from.call(e,e.p.data);if(e.p.ignoreCase&&(t=t.ignoreCase()),!0===e.p.search){var
w=e.p.postData.filters;if(w)"string"==typeof
w&&(w=$.jgrid.parse(w)),b(w);else
try{g=k[e.p.postData.searchField],"date"===g.stype&&g.srcfmt&&g.newfmt&&g.srcfmt!==g.newfmt&&(e.p.postData.searchString=$.jgrid.parseDate.call(e,g.newfmt,e.p.postData.searchString,g.srcfmt)),t=s[e.p.postData.searchOper](t)(e.p.postData.searchField,e.p.postData.searchString,k[e.p.postData.searchField])}catch(a){}}else
e.p.treeGrid&&"nested"===e.p.treeGridModel&&t.orderBy(e.p.treeReader.left_field,"asc","integer","",null);if(e.p.treeGrid&&"adjacency"===e.p.treeGridModel&&(o=0,h=null),e.p.grouping)for(p=0;p<o;p++)t.orderBy(m[p],r.groupOrder[p],l[p].stype,l[p].srcfmt);e.p.multiSort?$.each(h,function(a){t.orderBy(this,i[a],k[this].stype,k[this].srcfmt,k[this].sfunc)}):h&&e.p.sortorder&&j&&("DESC"===e.p.sortorder.toUpperCase()?t.orderBy(e.p.sortname,"d",k[h].stype,k[h].srcfmt,k[h].sfunc):t.orderBy(e.p.sortname,"a",k[h].stype,k[h].srcfmt,k[h].sfunc));var
x=t.select(),y=parseInt(e.p.rowNum,10),z=x.length,A=parseInt(e.p.page,10),B=Math.ceil(z/y),C={};if((e.p.search||e.p.resetsearch)&&e.p.grouping&&e.p.groupingView._locgr){e.p.groupingView.groups=[];var
D,E,F,G=$.jgrid.getMethod("groupingPrepare");if(e.p.footerrow&&e.p.userDataOnFooter){for(E
in
e.p.userData)e.p.userData.hasOwnProperty(E)&&(e.p.userData[E]=0);F=!0}for(D=0;D<z;D++){if(F)for(E
in
e.p.userData)e.p.userData.hasOwnProperty(E)&&(e.p.userData[E]+=parseFloat(x[D][E]||0));G.call($(e),x[D],D,y)}}return a?x:(x=e.p.treeGrid&&e.p.search?$(e).jqGrid("searchTree",x):x.slice((A-1)*y,A*y),t=null,k=null,C[e.p.localReader.total]=B,C[e.p.localReader.page]=A,C[e.p.localReader.records]=z,C[e.p.localReader.root]=x,C[e.p.localReader.userdata]=e.p.userData,x=null,C)}},S=function(a,b){var
