(function ($) {
  ...
  function init() {
    ...
    function getButton(td) {
      return jQuery(td).parent('tr').find('th.htRemoveRow').eq(0).find('.am-data-remove-row');
    }
  }
    ...
    walkontableConfig.rowHeaders = function () {
      ...
      var newRowHeader = function (row, elem) {
        ...
        if (row > -1) {
          ...
          div.className = 'am-data-remove-row am am-remove';
          elem.appendChild(div);

          jQuery(div).on('mouseup', function () {
