...
import com.mom.backend.mail.SMTPAuthenticator;
import com.mom.backend.serviceimpl.MomServiceImpl;
public class SMTPUtil {
	public static boolean sendMail(MomServiceImpl momService, String queryId,  Map<String,Object> param) {
...
//			Map<String, Object> result = momService.getMap("com.thirautech.mom.smtp.get_smtpinfo", param);
			...
			// 메일 첨부 할 내용 없으면 끝내기.
			/*
			 * if(htmlContents.equals("")) { continue; }
			 */
...
//				    Address toAddr = new InternetAddress(result.get("receivUser").toString());
	...
	public static boolean sendMail(MomServiceImpl momService, String queryId,  List<Map<String,Object>> paramList) {
...
//			System.out.println("param..........." + param.toString());
	...
	protected static String mailContents(MomServiceImpl momService, List<Map<String,Object>> paramList, Map<String, Object> mailInfo) {
